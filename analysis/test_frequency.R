...
ggsave(
  plot= p.all,
  filename="months_with_eGFR_all.png", path=here::here("output"),
)
...
ggsave(
  plot= p.at_risk,
  filename="months_with_eGFR_at_risk.png", path=here::here("output"))
...
ggsave(
  plot= p.diabetes,
  filename="months_with_eGFR_diabetes.png", path=here::here("output"))
...
ggsave(
  plot= p.hypertension,
  filename="months_with_eGFR_hypertension.png", path=here::here("output"))