...
for file in (OUTPUT_DIR / "joined").iterdir():
    if match_input_files(file.name):
        ...
        merged_df = merged_df.drop(["acr_x", "acr_code_x", "acr_count_x", "acr_numeric_value_x", "acr_operator_x"], axis=1)
        merged_df = merged_df.rename({"acr_y": "acr", "acr_code_y": "acr_code", "acr_count_y": "acr_count", "acr_numeric_value_y": "acr_numeric_value", "acr_operator": "acr_operator"})
