...
for file in OUTPUT_DIR.iterdir():
    if match_input_files(file.name):
        ...
        num_with_numeric_value_and_operator_creatinine = df.loc[df["creatinine_numeric_value"].notnull(),:].groupby("creatinine_operator")[["creatinine"]].sum()
        operators_creatinine.append(num_with_numeric_value_and_operator_creatinine)

        num_with_numeric_value_and_operator_cr_cl = df.loc[df["cr_cl_numeric_value"].notnull(),:].groupby("cr_cl_operator")[["cr_cl"]].sum()
...
creatinine_operators_count = creatinine_operators.groupby(creatinine_operators.index).sum()
